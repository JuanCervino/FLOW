...
class FedAlgorithm(object):
    ...
    def fit(self, weights, n_rounds=None, path=None):
        if n_rounds is None:
        ...
        for round in _range(n_rounds):
            ...
            # Juan Added This
            if path!=None and round % 100 == 0:
                model_file = f"./{path}/model_{round}.pth"
                torch.save(self.server_state.model.state_dict(), model_file)
